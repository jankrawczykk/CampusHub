...
class Student(BaseModel):
    ...
    @classmethod
    def create_with_person(cls, person_data: Dict[str, Any], student_data: Dict[str, Any], major_id: Optional[int] = None, existing_person_id: Optional[int] = None) -> Optional[int]:
        conn = get_database_connection()
        if not conn:
            return None
